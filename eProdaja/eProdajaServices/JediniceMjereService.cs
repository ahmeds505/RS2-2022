...
{
    public class JediniceMjereService 
        : BaseCRUDService<Model.JediniceMjere, Database.JediniceMjere, 
            JediniceMjereSearchObject, JediniceMjereUpsertRequest, JediniceMjereUpsertRequest>, 
